        ...
        <section class="contato" id="contato">
            ...
            <form action="" method="post">
                ...
                <div class="form-wraper">
                    ...
                    <input type="text" name="nome" id="nome-form" required placeholder="Digite seu nome..."
                        class="campo-formulario">
                </div>
                <div class="form-wraper">
                    <label for="email" class="left">E-Mail:</label><span class="contador-letras-contato">0/erro</span>
                    <input type="email" name="email" id="email-form" required placeholder="Digite seu e-mail..."
                        class="campo-formulario">
                </div>
                <div class="form-wraper">
                    <label for="msg" class="left">Mensagem:</label><span class="contador-letras-contato">0/erro</span>
                    <textarea name="msg" id="msg-form" rows="5" required placeholder="Digite sua mensagem..."
